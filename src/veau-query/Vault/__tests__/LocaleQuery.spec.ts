...
describe('LocaleQuery', () => {
  ...
  describe('findByISO639', () => {
    it('normal case', async () => {
      ...
      expect(language).toEqual(locale.getLanguages().get(0).get());
    });

    it('returns Failure when LocaleQuery.all returns Failure', async () => {
      const locale: Locale = Locale.of(Languages.of([
        Language.of(
          LanguageID.of(1),
          LanguageName.of('language'),
  ...
  describe('findByISO3166', () => {
    it('normal case', async () => {
      ...
      expect(region).toEqual(locale.getRegions().get(0).get());
    });
