...
describe('StatsItemQuery', () => {
  describe('normal case', () => {
    it('findByStatsID', async () => {
      ...
      const statsItems: Array<StatsItem> = await statsItemQuery.findByStatsID(StatsID.of(statsID));

      expect(statsItems.length).toEqual(3);
      expect(statsItems[0].getStatsItemID().get()).toEqual('c0e18d31-d026-4a84-af4f-d5d26c520600');
      ...
      expect(statsItems[1].getStatsItemID().get()).toEqual('5fb3c1aa-d23e-4eaa-9f67-01b8d3f24d0c');
      ...
      expect(statsItems[2].getStatsItemID().get()).toEqual('2ac64841-5267-48bc-8952-ba9ad1cb12d7');
