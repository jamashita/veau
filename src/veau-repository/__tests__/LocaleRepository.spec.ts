...
describe('LocaleRepository', () => {
  it('findByISO639', () => {
    ...
    const language: Language = localeRepository.findByISO639(iso6393);
  ...
  it('findByISO639: throws error', () => {
    ...
    expect(() => {
      localeRepository.findByISO639(iso6393);
  ...
  it('findByISO3166', () => {
    ...
    const region: Region = localeRepository.findByISO3166(iso31662);
  ...
  it('findByISO3166: throws error', () => {
    ...
    expect(() => {
      localeRepository.findByISO3166(iso31663);
    }).toThrow(NoSuchElementError);
  });
});
