...
describe('StatsItemRepository', () => {
  it('findByStatsID', async () => {
    ...
    expect(statsItems[0].getValues()[0].getAsOf().format('YYYY-MM-DD')).toEqual('2000-01-01');
    expect(statsItems[0].getValues()[0].getValue()).toEqual(1);
    expect(statsItems[0].getValues()[1].getAsOf().format('YYYY-MM-DD')).toEqual('2000-01-02');
    expect(statsItems[0].getValues()[1].getValue()).toEqual(2);
    expect(statsItems[0].getValues()[2].getAsOf().format('YYYY-MM-DD')).toEqual('2000-01-03');
    ...
    expect(statsItems[1].getValues()[0].getAsOf().format('YYYY-MM-DD')).toEqual('2001-01-01');
    expect(statsItems[1].getValues()[0].getValue()).toEqual(11);
    expect(statsItems[1].getValues()[1].getAsOf().format('YYYY-MM-DD')).toEqual('2001-01-02');
