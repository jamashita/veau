...
export const appearNotification: (kind: NotificationKind, horizontal: 'left' | 'center' | 'right', vertical: 'top' | 'bottom', message: string, duration: number, values?: {[key: string]: string}) => NotificationAppearAction = (kind: NotificationKind, horizontal: 'left' | 'center' | 'right', vertical: 'top' | 'bottom', message: string, duration: number, values?: {[key: string]: string}): NotificationAppearAction => {
  return {
