...
import { StatsOutlineFetchQuery } from '../StatsOutlineFetchQuery';

describe('StatsOutlineFetchQuery', () => {
  describe('container', () => {
    it('must be a singleton', () => {
      expect.assertions(2);

      const statsOutlineQuery1: StatsOutlineFetchQuery = bin.get<StatsOutlineFetchQuery>(Type.StatsOutlineFetchQuery);
      const statsOutlineQuery2: StatsOutlineFetchQuery = bin.get<StatsOutlineFetchQuery>(Type.StatsOutlineFetchQuery);

      expect(statsOutlineQuery1).toBeInstanceOf(StatsOutlineFetchQuery);
  ...
  describe('findByPage', () => {
    it('normal case', async () => {
      ...
      const statsOutlineQuery: StatsOutlineFetchQuery = new StatsOutlineFetchQuery(ajax);
