...
import { LocaleFetchQuery } from '../LocaleFetchQuery';

describe('LocaleFetchQuery', () => {
  describe('container', () => {
    it('must be a singleton', () => {
      expect.assertions(2);

      const localeQuery1: LocaleFetchQuery = bin.get<LocaleFetchQuery>(Type.LocaleFetchQuery);
      const localeQuery2: LocaleFetchQuery = bin.get<LocaleFetchQuery>(Type.LocaleFetchQuery);

      expect(localeQuery1).toBeInstanceOf(LocaleFetchQuery);
  ...
  describe('all', () => {
    it('normal case', async () => {
      ...
      const localeQuery: LocaleFetchQuery = new LocaleFetchQuery(ajax);
