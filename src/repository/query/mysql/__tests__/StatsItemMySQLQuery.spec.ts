...
describe('StatsItemMySQLQuery', () => {
  describe('container', () => {
    it('must be a singleton', () => {
      ...
      const statsItemQuery1: StatsItemMySQLQuery = cask.get<StatsItemMySQLQuery>(Type.StatsItemMySQLQuery);
      const statsItemQuery2: StatsItemMySQLQuery = cask.get<StatsItemMySQLQuery>(Type.StatsItemMySQLQuery);

      expect(statsItemQuery1).toBeInstanceOf(StatsItemMySQLQuery);
  ...
  describe('findByStatsID', () => {
    it('normal case', async () => {
      ...
      const statsItemQuery: StatsItemMySQLQuery = new StatsItemMySQLQuery(mysql, statsValueQuery);
    ...
    it('returns Dead when StatsValueMySQLQuery throws StatsValueError', async () => {
      expect.assertions(2);
    ...
    it('returns Dead when StatsValueMySQLQuery throws MySQLError', async () => {
      expect.assertions(2);
