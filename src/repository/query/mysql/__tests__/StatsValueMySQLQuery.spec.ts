...
describe('StatsValueMySQLQuery', () => {
  describe('container', () => {
    it('must be a singleton', () => {
      ...
      const statsValueQuery1: StatsValueMySQLQuery = cask.get<StatsValueMySQLQuery>(Type.StatsValueMySQLQuery);
      const statsValueQuery2: StatsValueMySQLQuery = cask.get<StatsValueMySQLQuery>(Type.StatsValueMySQLQuery);

      expect(statsValueQuery1).toBeInstanceOf(StatsValueMySQLQuery);
  ...
  describe('findByStatsID', () => {
    it('normal case', async () => {
      ...
      const statsValueQuery: StatsValueMySQLQuery = new StatsValueMySQLQuery(mysql);
