...
describe('RegionMySQLQuery', () => {
  describe('container', () => {
    it('must be a singleton', () => {
      ...
      const regionQuery1: RegionMySQLQuery = cask.get<RegionMySQLQuery>(Type.RegionMySQLQuery);
      const regionQuery2: RegionMySQLQuery = cask.get<RegionMySQLQuery>(Type.RegionMySQLQuery);

      expect(regionQuery1).toBeInstanceOf(RegionMySQLQuery);
  ...
  describe('all', () => {
    it('normal case', async () => {
      ...
      const regionQuery: RegionMySQLQuery = new RegionMySQLQuery(mysql);
