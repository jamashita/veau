...
describe('StatsValue', () => {
  describe('equals', () => {
    it('returns true if the all properties are the same', () => {
      const statsValue1: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-01').get(), NumericalValue.of(0));
      const statsValue2: StatsValue = StatsValue.of(StatsItemID.ofString('b5f208c3-f171-488f-a8dc-f3798db5f9f4').get(), AsOf.ofString('2000-01-01').get(), NumericalValue.of(0));
      const statsValue3: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-02').get(), NumericalValue.of(0));
      const statsValue4: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-01').get(), NumericalValue.of(-1));
      const statsValue5: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-01').get(), NumericalValue.of(1));
      const statsValue6: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-01').get(), NumericalValue.of(0));
  ...
  describe('isBefore', () => {
    it('returns true if the asOf is before than the other StatsValue', () => {
      const statsValue1: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-01').get(), NumericalValue.of(0));
      const statsValue2: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-02').get(), NumericalValue.of(0));
      const statsValue3: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-03').get(), NumericalValue.of(0));
  ...
  describe('toJSON', () => {
    it('normal case', () => {
      const statsValue: StatsValue = StatsValue.of(StatsItemID.ofString('f186dad1-6170-4fdc-9020-d73d9bf86fb0').get(), AsOf.ofString('2000-01-01').get(), NumericalValue.of(1));
