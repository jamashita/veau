...
describe('StatsItemID', () => {
  describe('equals', () => {
    it('returns true if the property is the same', () => {
      ...
      const statsItemID1: StatsItemID = StatsItemID.of(UUID.of(uuid1));
      const statsItemID2: StatsItemID = StatsItemID.of(UUID.of(uuid2));
      const statsItemID3: StatsItemID = StatsItemID.of(UUID.of(uuid1));
