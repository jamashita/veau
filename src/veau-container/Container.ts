...
import { IStatsItemQuery } from '../veau-query/interfaces/IStatsItemQuery';
...
container.bind<IStatsItemQuery>(TYPE.StatsItemQuery).to(StatsItemQuery).inSingletonScope();
