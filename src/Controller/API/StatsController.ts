...
export class StatsController {
  ...
  public list(@Param('page') pg: number, @Res() res: Response): Promise<Response<unknown>> {
    return Page.of(pg).match<Promise<Response<unknown>>>(async (page: Page) => {
      ...
      return superposition.match<Response<unknown>>((outlines: JSONable) => {
  ...
  public refer(@Param('statsID') id: string, @Res() res: Response): Promise<Response<unknown>> {
    return StatsID.ofString(id).match<Promise<Response<unknown>>>(async (statsID: StatsID) => {
      ...
      return superposition.match<Response<unknown>>((stats: JSONable) => {
  ...
  public register(@Body() body: PlainObject, @Res() res: Response): Promise<Response<unknown>> {
    ...
    return Stats.ofJSON(body).match<Promise<Response<unknown>>>(async (stats: Stats) => {
