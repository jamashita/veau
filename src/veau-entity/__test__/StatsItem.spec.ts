...
describe('StatsItem', () => {
  it('equals', () => {
    ...
    const statsItem1: StatsItem = new StatsItem(statsItemID1, Term.DAILY, 'name 1', 'unit 1', 1, []);
    const statsItem2: StatsItem = new StatsItem(statsItemID2, Term.DAILY, 'name 1', 'unit 1', 1, []);
    const statsItem3: StatsItem = new StatsItem(statsItemID1, Term.ANNUAL, 'name 3', 'unit 3', 2, [StatsValue.of(moment('2000-01-01'), 10)]);
  ...
  it('toJSON', () => {
    ...
    const statsItem: StatsItem = new StatsItem(statsItemID, Term.DAILY, 'name 1', 'unit 1', 1, [StatsValue.of(moment('2000-01-01'), 10)]);
