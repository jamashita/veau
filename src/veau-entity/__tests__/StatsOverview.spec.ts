...
describe('StatsOverview', () => {
  it('equals', () => {
    const statsOverView1: StatsOverview = new StatsOverview(
      StatsID.of(UUID.of('1a607fff-12c2-4d8d-a55a-75fa23971393')),
      ISO639.of('ab'),
      ISO3166.of('AFG'),
      Term.DAILY,
      'stats overview 1',
    ...
    const statsOverView2: StatsOverview = new StatsOverview(
      StatsID.of(UUID.of('d7c3437f-8c1f-4542-abef-bd25d900039e')),
      ISO639.of('ab'),
      ISO3166.of('AFG'),
      Term.DAILY,
      'stats overview 1',
    ...
    const statsOverView3: StatsOverview = new StatsOverview(
      StatsID.of(UUID.of('1a607fff-12c2-4d8d-a55a-75fa23971393')),
      ISO639.of('aa'),
      ISO3166.of('ALB'),
      Term.WEEKLY,
  ...
  it('toJSON', () => {
    const statsOverView: StatsOverview = new StatsOverview(
      StatsID.of(UUID.of('1a607fff-12c2-4d8d-a55a-75fa23971393')),
      ISO639.of('ab'),
      ISO3166.of('AFG'),
      Term.DAILY,
