...
describe('StatsItem', () => {
  ...
  describe('getAdOfs', () => {
    it('extract only their asOfs', () => {
      ...
      const statsItem: StatsItem = new StatsItem(StatsItemID.of('0816ef5e-752d-41ad-b52a-95b1f16e3bbd'), 'name 1', StatsValues.of(
        [
  ...
  describe('getValuesByColumn', () => {
    it('returns empty string when the date is empty ', () => {
      ...
      const statsItem: StatsItem = new StatsItem(StatsItemID.of('aa28c422-67e2-41e2-bbe6-a97c7d63c44f'), 'name 1', StatsValues.of([
  ...
  describe('isFilled', () => {
    it('returns true if the name is filled', () => {
      const statsItem1: StatsItem = new StatsItem(StatsItemID.of('5ee0c273-c26f-432f-9217-d6a7b481a073'), '', StatsValues.of([]));
      const statsItem2: StatsItem = new StatsItem(StatsItemID.of('5ee0c273-c26f-432f-9217-d6a7b481a073'), 'name', StatsValues.of([]));
