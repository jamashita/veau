...
export const STATS_OUTLINE_UPDATE = '@@veau/STATS_OUTLINE_UPDATE' as const;
export const STATS_OUTLINE_RESET = '@@veau/STATS_OUTLINE_RESET' as const;
...
export const STATS_ITEM_RESET = '@@veau/STATS_ITEM_RESET' as const;
