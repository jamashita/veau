...
# テーブルのダンプ caption_names
# ------------------------------------------------------------

DROP TABLE IF EXISTS `caption_names`;

CREATE TABLE `caption_names` (
  ...
  KEY `name` (`name`),
  CONSTRAINT `caption_names_ibfk_1` FOREIGN KEY (`caption_id`) REFERENCES `captions` (`caption_id`),
  CONSTRAINT `caption_names_ibfk_2` FOREIGN KEY (`language_id`) REFERENCES `languages` (`language_id`)
...
CREATE TABLE `captions` (
  ...
  `acquirable` tinyint(3) unsigned NOT NULL,
  `displayable` tinyint(3) unsigned NOT NULL,
...
CREATE TABLE `periods` (
  `period_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `period` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO `periods` (`period_id`, `period`)
VALUES
	(1,X'616E6E75616C'),
	(2,X'73656D6920616E6E75616C'),
	(3,X'717561727465726C79'),
	(4,X'6D6F6E74686C79');
...
# テーブルのダンプ source_names
# ------------------------------------------------------------

DROP TABLE IF EXISTS `source_names`;
...
CREATE TABLE `source_names` (
  ...
  PRIMARY KEY (`caption_id`,`language_id`),
  KEY `language_id` (`language_id`),
  CONSTRAINT `source_names_ibfk_1` FOREIGN KEY (`caption_id`) REFERENCES `captions` (`caption_id`),
  CONSTRAINT `source_names_ibfk_2` FOREIGN KEY (`language_id`) REFERENCES `languages` (`language_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



# テーブルのダンプ source_url_map
# ------------------------------------------------------------

DROP TABLE IF EXISTS `source_url_map`;

CREATE TABLE `source_url_map` (
  `caption_id` mediumint(8) unsigned NOT NULL,
  `source_url_id` mediumint(8) unsigned NOT NULL,
  PRIMARY KEY (`caption_id`),
  KEY `source_url_id` (`source_url_id`),
  CONSTRAINT `source_url_map_ibfk_1` FOREIGN KEY (`caption_id`) REFERENCES `captions` (`caption_id`),
  CONSTRAINT `source_url_map_ibfk_2` FOREIGN KEY (`source_url_id`) REFERENCES `source_urls` (`source_url_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



# テーブルのダンプ source_urls
# ------------------------------------------------------------

DROP TABLE IF EXISTS `source_urls`;

CREATE TABLE `source_urls` (
  `source_url_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `url` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `stats` (
  ...
  `original_seq` tinyint(3) unsigned NOT NULL,
  `acquirable` tinyint(3) unsigned NOT NULL,
  `displayable` tinyint(3) unsigned NOT NULL,
  ...
  CONSTRAINT `stats_ibfk_1` FOREIGN KEY (`locale_id`) REFERENCES `locales` (`locale_id`),
  CONSTRAINT `stats_ibfk_2` FOREIGN KEY (`caption_id`) REFERENCES `captions` (`caption_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



# テーブルのダンプ stats_hierarchy
# ------------------------------------------------------------

DROP TABLE IF EXISTS `stats_hierarchy`;

CREATE TABLE `stats_hierarchy` (
  `parent_stats_id` int(10) unsigned NOT NULL,
  `child_stats_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`parent_stats_id`,`child_stats_id`),
  KEY `child_stats_id` (`child_stats_id`),
  CONSTRAINT `stats_hierarchy_ibfk_1` FOREIGN KEY (`parent_stats_id`) REFERENCES `stats` (`stats_id`),
  CONSTRAINT `stats_hierarchy_ibfk_2` FOREIGN KEY (`child_stats_id`) REFERENCES `stats` (`stats_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



# テーブルのダンプ stats_items
# ------------------------------------------------------------
...
CREATE TABLE `stats_items` (
  ...
  `estimated` tinyint(3) unsigned NOT NULL,
...
# テーブルのダンプ stats_names
# ------------------------------------------------------------

DROP TABLE IF EXISTS `stats_names`;

CREATE TABLE `stats_names` (
  `stats_id` int(10) unsigned NOT NULL,
  `language_id` tinyint(3) unsigned NOT NULL,
  `name` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`stats_id`,`language_id`),
  KEY `language_id` (`language_id`),
  CONSTRAINT `stats_names_ibfk_1` FOREIGN KEY (`stats_id`) REFERENCES `stats` (`stats_id`),
  CONSTRAINT `stats_names_ibfk_2` FOREIGN KEY (`language_id`) REFERENCES `languages` (`language_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



# テーブルのダンプ stats_units
# ------------------------------------------------------------

DROP TABLE IF EXISTS `stats_units`;

CREATE TABLE `stats_units` (
  `stats_id` int(10) unsigned NOT NULL,
  `language_id` tinyint(3) unsigned NOT NULL,
  `unit_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`stats_id`,`language_id`),
  KEY `language_id` (`language_id`),
  CONSTRAINT `stats_units_ibfk_1` FOREIGN KEY (`stats_id`) REFERENCES `stats` (`stats_id`),
  CONSTRAINT `stats_units_ibfk_2` FOREIGN KEY (`language_id`) REFERENCES `languages` (`language_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `terms` (
  ...
  `terms` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`term_id`),
  UNIQUE KEY `terms` (`terms`),
  KEY `period_id` (`period_id`),
  CONSTRAINT `terms_ibfk_1` FOREIGN KEY (`period_id`) REFERENCES `periods` (`period_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

LOCK TABLES `terms` WRITE;
/*!40000 ALTER TABLE `terms` DISABLE KEYS */;

INSERT INTO `terms` (`term_id`, `period_id`, `terms`)
VALUES
	(1,1,X'465934'),
	(2,2,X'484631'),
	(3,2,X'484632'),
